export const tableList = {
  needList: {
    tableTitle: ['编号', '需求单名', '类型', '类型ID', '数量', '日期', '提交专员编号', '详情', '操作', '状态'],
    tableBody: ['needid', 'needtitle', 'itemtype', 'itemid', 'neednum', 'needday', 'neederid', 'comment', 'opetation1', 'opetation2']
  },
  buyList: {
    tableTitle: ['编号', '购买单名', '日期', '类型', '数量', '购买编号', '提交者编号', '操作'],
    tableBody: ['buyid', 'buytitle', 'btime', 'itemtype', 'num', 'buyerid', 'neederid', 'opetation']
  },
  departmentList: {
  ...
  userListedit: {
    tableTitle: ['编号', '用户名', '电话号码', '职工号', '职位', '操作'],
    tableBody: ['userid', 'username', 'telNum', 'employeeid', 'departmentid', 'opetation']
  },
  userListsee: {
