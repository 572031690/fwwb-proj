    ...
    >
      <div class="drawerStyle">
        <el-form :model="form" label-width="120px">
          <div class="topstatus">
            <el-steps :space="200" :active="form.uptype" finish-status="success">
          ...
          <el-form-item label="需求单名" prop="needtitle">
            <el-input v-model="form.needtitle" style="width: 300px" disabled></el-input>
          </el-form-item>
          <el-form-item label="类型" prop="itemtype">
            <el-input v-model="form.needtitle" style="width: 200px" disabled></el-input>
          </el-form-item>
