...
export default {
  ...
  methods: {
    ...
    add () {
      if (this.dialogData.dataTableList[0].dataName === this.topChange && this.dialogData.dataTableList[0].dataName) this.dialogData.dataTableList.splice(0, 1)
      for (const i in this.dialogData.formList) {
        this.dialogData.formList[i] = ''
      }
    },
    edit () {
      if (this.dialogData.dataTableList[0].dataName !== this.topChange && this.dialogData.dataTableList[0].dataName) this.dialogData.dataTableList.splice(0, 0, this.topData)
      for (const i in this.dialogData.formList) {
    ...
    approval () {
      if (this.dialogData.dataTableList[0].dataName !== this.topChange) this.dialogData.dataTableList.splice(0, 0, this.topData)
      for (const i in this.dialogData.formList) {
        if (this.IntList.includes(i)) this.dialogData.formList[i] = parseInt(this.currentList[i])
        else this.dialogData.formList[i] = this.currentList[i]
      }
