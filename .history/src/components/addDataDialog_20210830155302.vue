  ...
  methods: {
    ...
    async adddata() {
      ...
      const { data: res } = await this.$ajax.post(
        url,
        {
          buyid: this.formList.buyid,
          buytitle: this.formList.buytitle,
          btime: this.formList.btime,
          itemtype: this.formList.itemtype,
          itemid: this.formList.itemid,
          num: this.formList.num,
          buyerid: this.formList.buyerid,
          neederid: this.formList.neederid
        },
        {}
      );
      if (res) {
