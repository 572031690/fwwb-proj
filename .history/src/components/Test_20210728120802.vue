        ...
        <div style="width:400px;margin-left:40px;">
          ...
          <div class="block">
            <el-timeline>
              ...
              >
                <el-card>
                  <span style="font-weight:bold;">{{ item.top }}</span><span v-show= 'item.auther'> 审批人：{{ item.auther }}</span>
                  <br> <span v-show= 'item.upname'> 提交人：{{ item.upname }}</span>
                  <p>{{ item.text }}</p>
    ...
    return {
      ...
      list: [
        ...
        },
        {
          ...
          auther: '马家辉',
          upname: '莫恩康',
          text: '审批意见：这次可以的加油这次可以的加油这次可以的加油这次可以的加油这次可以的加油',
          icon: 'el-icon-check',
          color: '#0bbd87'
        },
        {
          ...
          auther: '马家辉',
          upname: '莫恩康',
          text: '审批意见：王小虎 提交于 2018/4/3 20:46',
          icon: 'el-icon-close',
          color: 'red'
        }
      ],
