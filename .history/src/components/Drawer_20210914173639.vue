      ...
      <div class="drawercenter">
        <div class="drawerStyle" :style="{'width': openType === 'write'? '720px':'520px'}">
          ...
          <div class="formBox">
            ...
            <div  class="approvalBoxRight" v-if="openType === 'write'">
              <h3>审批详情</h3>
              <hr />
              <br />
              <div class="block">
          ...
          <div  class="approvalBox" v-if="openType === 'see'">
            <h3>审批详情</h3>
            <hr />
            <br />
            <div class="block">
          ...
          <div class="demo-drawer__footer">
            ...
            <div v-else>
              <el-button @click="cancelForm">关 闭</el-button>
              <el-button @click="cancelForm" type="danger">驳 回</el-button>
              <el-button @click="cancelForm"  type="success">通 过</el-button>
            </div>
          </div>
        </div>
      </div>
