...
export default {
  props: {
    ...
    topChange: {
      type: String,
      default: () => {
        return this.addEditList[this.name].dataTableList[0].dataName
      }
    }
  },
  watch: {
  ...
  methods: {
    ...
    getType () {
      console.log(this.topChange, 'topChange')
      this[this.openType]()
    },
    add () {
      if (this.dialogData.dataTableList[0].dataName === this.topChange) this.dialogData.dataTableList.splice(0, 1)
