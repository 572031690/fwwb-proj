...
export default {
  ...
  methods: {
    ...
    getAdminType () {
      ...
      } else if (this.departmentID === '10010' || this.departmentID === '10011') { // 需求部门经理10010  需求专员10011
        this.routerList[1].childrenList[1].showtab = false
        this.routerList[1].childrenList[0].showtab = true
      } else if (this.departmentID === '10020' || this.departmentID === '10021') { // 购买部门经理10020  购买专员10021
