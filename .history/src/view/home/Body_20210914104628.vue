              ...
              >
                ...
                >
                  ...
                  <div class="bodyButton" v-if="data==='opetation1'">
                    <div class="cell" v-if="departId()==='10010' || departId()==='10020'">
                      <button class="modify" @click="edData(item)"  v-if="item.uptype == 0 || item.uptype == 2">
                        编辑
                      </button>
                      <button class="delete" @click="deletedata(item)"  v-if="item.uptype == 0 || item.uptype == 2">
                        删除
                      </button>
                    ...
                    <div class="cell"  v-if="departId()==='10000' || departId()==='10001'">
                      <button class="writeApproval" @click="seeApproval(key)">
                        审批
                      </button>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    // 获取登录账号信息
    getTyp () {
      console.log('object,', this.departId())
    },
    // 抽屉关闭事件
    drawerClose (val) {
      console.log(val, '=------------')
