          ...
          <div class="body-top">
              ...
              <div class="bodytop-heart">
                <el-row>
                  ...
                  <el-col :span="8" v-if="departId()==='10010' || departId()==='10020'">
                ...
                >
                  ...
                  <div class="bodyButton" v-if="data==='opetation1'">
                    <div class="cell" v-if="departId()==='10010' || departId()==='10020'">
                      ...
                      <button class="delete" @click="deletedata({needid: item.needid},'/webneed/deleteNeed')"  v-if="item.uptype == 0 || item.uptype == 2">
                        删除
                      </button>
