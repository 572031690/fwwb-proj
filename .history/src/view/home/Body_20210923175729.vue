              ...
              >
                ...
                >
                  ...
                  <div class="bodyButton" v-if="data==='opetation1'">
                    <div class="cell" v-if="sessionStorage.getItem('currentRouter')==='see' ">
                    ...
                    <div class="cell"  v-if="sessionStorage.getItem('currentRouter')==='approval'">
...
export default {
  ...
  methods: {
    // 获取登录账号信息
    getTyp () {
      if (this.$store.state.departmentId === '10010' || this.$store.state.departmentId === '10001') this.drawOpenType = 'write'
