          ...
          <tbody>
            <tr v-for="(item, key) in list" :key="key">
              ...
              >
                ...
                <div class="cell" v-if="data!=='opetation' && data!=='opetationRole' && data!=='roleStatus'&& data!=='diabledRole'">
                ...
                <div class="cell" v-if="data==='opetationRole'">
                  ...
                  <button class="delete" @click="getRole(item)">禁用</button>
                </div>
                <div class="cell" v-if="data==='roleStatus'">
                  <span class="tipsspan" :style="{
                    'background-color': item.uptype == 0?'rgb(226, 63, 63)':'rgb(23, 165, 23)',
                    'color': item.uptype == 0?'black':'white'
                    }">
                      {{item.disabledRole == 0 ? '正常' : '禁用'}}
                  </span>
                </div>
                <div class="cell" v-if="data==='diabledRole'">
                  <button class="delete" @click="getRole(item)">禁用</button>
                </div>
              </td>
            </tr>
