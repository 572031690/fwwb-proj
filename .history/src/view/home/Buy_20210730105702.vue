        ...
        <div class="bodyheart">
            ...
            <div class="tablebody" v-loading="loading2" element-loading-text="拼命加载中">
                <div  class="table-top">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th colspan="1" rowspan="1" class="htop-th2"><div class="cell">购买单名</div></th>
                            <th colspan="1" rowspan="1" class="htop-th3"><div class="cell">日期</div></th>
                            <th colspan="1" rowspan="1" class="htop-th4"><div class="cell">类型</div></th>
                            <th colspan="1" rowspan="1" class="htop-th5"><div class="cell">类型ID</div></th>
                            <th colspan="1" rowspan="1" class="htop-th6"><div class="cell">数量</div></th>
                             <th colspan="1" rowspan="1" class="htop-th5"><div class="cell">购买编号</div></th>
                            <th colspan="1" rowspan="1" class="htop-th5"><div class="cell">提交者编号</div></th>
                ...
                <!-- <el-table v-loading="loading2" element-loading-text="拼命加载中"> -->
                            ...
                            <el-dialog title="修改数据" :visible.sync="dialogFormVisible" :modal-append-to-body='false' :close-on-click-modal="false" :show-close="false" center  width="35%">
                                <el-form :model="form" :rules="rules" ref="form" label-width="120px" class="demo-ruleForm">
                                    <el-form-item label="编号ID" prop="buyid" >
                                        <el-input type="age" v-model.number="form.buyid" auto-complete="off" style="width:400px" disabled></el-input>
                                    </el-form-item>
                                    ...
                                    <el-form-item label="日期" prop="btime">
                                        <el-col :span="11">
                                        <el-date-picker type="date" placeholder="选择日期" v-model="form.btime" style="width: 150px;"></el-date-picker>
                                        </el-col>
                                    ...
                                    <el-form-item label="数量" prop="num" >
                                        ...
                                        <el-input-number v-model="form.num" :step="50" :min="50" :max="999999999" label="描述文字"></el-input-number>
                                    </el-form-item>

                                    <el-form-item label="购买编号" prop="buyerid"  >
                                        <el-input type="age" v-model="form.buyerid" auto-complete="off" style="width:400px" ></el-input>
                                    </el-form-item>
                                    <el-form-item label="负责人编号" prop="neederid"  >
                                        <el-input type="age" v-model="form.neederid" auto-complete="off" style="width:400px" disabled></el-input>
                                    </el-form-item>
                    ...
                    <!-- 添加模板 -->
                    <el-dialog title="添加数据" :visible.sync="dialogFormVisibleadd" :modal-append-to-body='false' :close-on-click-modal="false" :show-close="false" center  width="35%">
                                <el-form :model="addform" :rules="rules" ref="form" label-width="120px" class="demo-ruleForm">
                                    ...
                                    <el-form-item label="日期" prop="btime">
                                        <el-col :span="11">
                                        <el-date-picker type="date" placeholder="选择日期" v-model="addform.btime" style="width: 150px;"></el-date-picker>
                                        </el-col>
                                        <el-col class="line" :span="2">-</el-col>
                                        <!-- <el-col :span="11">
                                        <el-time-picker placeholder="选择时间" v-model="form.date2" style="width: 100%;"></el-time-picker>
                                    ...
                                    <el-form-item label="数量" prop="num" >
                                        <!-- <el-input type="age" v-model.number="form.neednum" auto-complete="off" style="width:400px"></el-input> -->
                                        <el-input-number v-model="addform.num" :step="50" :min="50" :max="999999999" label="描述文字"></el-input-number>
                                    </el-form-item>

                                    <el-form-item label="购买编号" prop="buyerid"  >
                                        <el-input type="age" v-model.number="addform.buyerid" auto-complete="off" style="width:400px" ></el-input>
                                    </el-form-item>
                                    <el-form-item label="负责人编号" prop="neederid"  >
                                        <el-input type="age" v-model.number="list[0].neederid" auto-complete="off" style="width:400px" disabled></el-input>
                                    </el-form-item>

                                </el-form>
                                <div slot="footer" class="dialog-footer">
                                    <el-button @click="dialogFormVisibleadd = false">取 消</el-button>
                                    <el-button type="primary" @click="submitFormadd('addform')">添 加</el-button>
                                </div>
                            </el-dialog>
...
export default {
  ...
  methods: {
    ...
    async adddata () {
      ...
      const { data: res } = await this.$ajax.post(url,
        {
