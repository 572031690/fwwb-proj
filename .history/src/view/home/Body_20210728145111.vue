  ...
  <div class="right-body" id="body">
    <div class="bodyheart">
      ...
      >
          ...
          <tr v-for="(item, key) in list" :class="{ uppdate: item.uptype == 1 || item.uptype == 3 }">
            ...
            <td class="body-td1">
              ...
              <div v-if="item.uptype == 2">
                <button class="approval" @click="upData(item)">驳回结果</button>
              </div>
        ...
        <!-- 修改表单/ 提交表单 -->
        <el-dialog
          :title="form.uptype == 0 || form.uptype === 2 ? '修改数据':form.uptype === 1 ? '提交送审' : '再次提交送审'"
        ...
        >
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button
              ...
              v-show="form.uptype === 0 || form.uptype === 2"
              >保 存</el-button
            >
            <el-button
              type="primary"
              @click="updateForm('form')"
              v-show="form.uptype == 10"
              >提交</el-button
            >
          </div>
        </el-dialog>
