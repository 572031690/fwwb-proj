...
export default {
  ...
  methods: {
    ...
    changehomeimg() {
      ...
      const me = this;
      setTimeout(function() {
        this.$refs.spans1[0].style.display = status;
        this.$refs.spans2[0].style.display = status;
        this.$refs.spans3[0].style.display = status;
        this.$refs.arrow[0].style.display = status;
        this.$refs.spans5[0].style.display = status;
        this.$refs.spans6[0].style.display = status;
        this.$refs.spans7[0].style.display = status;
        this.$refs.spans8[0].style.display = status;
      }, times);
    },
    // 开始动画文字出现延迟
    changehomeimgCreate() {
