...
export default {
  ...
  methods: {
    ...
    goToRouter (val) {
      ...
      if (val.index === 21 || val.index === 23) {window.sessionStorage.setItem('currentRouter', 'see') this.$refs.viewBox.getCurrentType()}
      if (val.index === 61 || val.index === 62) {window.sessionStorage.setItem('currentRouter', 'approval') this.$refs.viewBox.getCurrentType()}
  ...
  created () {
    window.sessionStorage.setItem('sData', ['10010', '10011'])
