...
export default {
  ...
  methods: {
    ...
    goToRouter (val) {
      ...
      if (val.index === 21 || val.index === 23) window.sessionStorage.setItem('currentRouter', 'see')
      if (val.index === 61 || val.index === 62) window.sessionStorage.setItem('currentRouter', 'approval')
