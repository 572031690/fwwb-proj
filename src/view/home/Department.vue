            ...
            <div class="tablebody" v-loading="loading2" element-loading-text="拼命加载中">
                <div  class="table-top">
                    <thead>
                        <!-- 表头 -->
                        <tr>
                            <th colspan="1" rowspan="1" class="htop-th2"><div class="cell">部门姓名</div></th>
                            <th colspan="1" rowspan="1" class="htop-th2"><div class="cell">部门编号</div></th>
                ...
                <!-- <el-table v-loading="loading2" element-loading-text="拼命加载中"> -->
                            ...
                            <el-dialog title="修改数据" :visible.sync="dialogFormVisible" :modal-append-to-body='false' :close-on-click-modal="false" :show-close="false" center  width="35%">
                                <el-form :model="form" :rules="rules" ref="form" label-width="120px" class="demo-ruleForm">
                                    ...
                                    <el-form-item label="部门名称"  prop="departmentname">
                                        <el-input v-model="form.departmentname" style="width:400px"></el-input>
                                    </el-form-item>
                                    <el-form-item label="部门编号" prop="departmentid"  >
                                        <el-input type="age" v-model="form.departmentid" auto-complete="off" style="width:400px" ></el-input>
                                    </el-form-item>
                    ...
                    <el-dialog title="添加数据" :visible.sync="dialogFormVisibleadd" :modal-append-to-body='false' :close-on-click-modal="false" :show-close="false" center  width="35%">
                                <el-form :model="addform" :rules="rules" ref="form" label-width="120px" class="demo-ruleForm">
                                    ...
                                    <el-form-item label="部门名称"  prop="departmentname">
                                        <el-input v-model="addform.departmentname" style="width:400px"></el-input>
                                    </el-form-item>
                                    <el-form-item label="部门编号" prop="departmentid"  >
                                        <el-input type="age" v-model.number="addform.departmentid" auto-complete="off" style="width:400px" ></el-input>
                                    </el-form-item>
