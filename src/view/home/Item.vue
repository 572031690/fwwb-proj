            ...
            <div class="tablebody" v-loading="loading2" element-loading-text="拼命加载中">
                <div  class="table-top">
                    <thead>
                        <!-- 表头 -->
                        <tr>
                             <th colspan="1" rowspan="1" class="htop-th4"><div class="cell">类型ID</div></th>
                             <th colspan="1" rowspan="1" class="htop-th3"><div class="cell">类型</div></th>
                             <th colspan="1" rowspan="1" class="htop-th2"><div class="cell">描述</div></th>
                             <th colspan="1" rowspan="1" class="htop-th5"><div class="cell">数量</div></th>
                            <th colspan="1" rowspan="1" class="htop-th1"><div class="cell">单位</div></th>
                ...
                <!-- <el-table v-loading="loading2" element-loading-text="拼命加载中"> -->
                            ...
                            <el-dialog title="修改数据" :visible.sync="dialogFormVisible" :modal-append-to-body='false' :close-on-click-modal="false" :show-close="false" center  width="35%">
                                <el-form :model="form" :rules="rules" ref="form" label-width="120px" class="demo-ruleForm">
                                    <el-form-item label="编号ID" prop="needid" >
                                        <el-input type="age" v-model.number="form.needid" auto-complete="off" style="width:400px" disabled></el-input>
                                    </el-form-item>
                                <el-form-item label="需求单名"  prop="needtitle">
                                    ...
                                    <el-form-item label="数量" prop="neednum" >
                                        ...
                                        <el-input-number v-model="form.neednum" :step="50" :min="50" :max="999999999" label="描述文字"></el-input-number>
                                    </el-form-item>
                                     <el-form-item label="需求日期" prop="needday">
                                        <el-col :span="11">
                                        <el-date-picker type="date" placeholder="选择日期" v-model="form.needday" style="width: 150px;"></el-date-picker>
                                        </el-col>
                                    ...
                                    <el-form-item label="详情" prop="comment" >
                                        <el-input type="textarea" v-model.number="form.comment" auto-complete="off" style="width:400px" ></el-input>
                                    </el-form-item>
                    ...
                    <el-dialog title="添加数据" :visible.sync="dialogFormVisibleadd" :modal-append-to-body='false' :close-on-click-modal="false" :show-close="false" center  width="35%">
                                ...
                                <el-form-item label="需求单名"  prop="needtitle">
                                        <el-input v-model="addform.needtitle" style="width:400px"></el-input>
                                    </el-form-item>
                                    <el-form-item label="类型" prop="itemtype">
                                    ...
                                    <el-form-item label="数量" prop="neednum" >
                                        <!-- <el-input type="age" v-model.number="form.neednum" auto-complete="off" style="width:400px"></el-input> -->
                                        <el-input-number v-model="addform.neednum" :step="50" :min="50" :max="999999999" label="描述文字"></el-input-number>
                                    </el-form-item>
                                     <el-form-item label="需求日期" prop="needday">
                                        <el-col :span="11">
                                        <el-date-picker type="date" placeholder="选择日期" v-model="addform.needday" style="width: 150px;"></el-date-picker>
                                        </el-col>
                                        <el-col class="line" :span="2">-</el-col>
                                        <!-- <el-col :span="11">
                                        <el-time-picker placeholder="选择时间" v-model="form.date2" style="width: 100%;"></el-time-picker>
                                    ...
                                    <el-form-item label="负责人部门编号" prop="neederid"  >
                                        <el-input type="age" v-model="list[0].neederid" auto-complete="off" style="width:400px" disabled></el-input>
                                    </el-form-item>
                                    <el-form-item label="详情" prop="comment" >
                                        <el-input type="textarea" v-model.number="addform.comment" auto-complete="off" style="width:400px" ></el-input>
                                    </el-form-item>
